    ...
    private void btnSave_OnAction(ActionEvent event) {
        ...
        if (btnSave.getText().equals("Save")) {
            ...
            try {
                ...
                new Alert(Alert.AlertType.ERROR, "Successfully save the item",ButtonType.OK).show();
            } catch (Exception e) {
                e.printStackTrace();
            ...
            try {
               itemBO.updateItem(txtDescription.getText(),  qtyOnHand, unitPrice, selectedItem.getCode());
                new Alert(Alert.AlertType.ERROR, "Successfully pdate the item",ButtonType.OK).show();
            } catch (Exception e) {
                e.printStackTrace();
        ...
        if (buttonType.get() == ButtonType.YES) {
            ...
            try {
               itemBO.deleteItem(selectedItem.getCode());
                ...
                new Alert(Alert.AlertType.ERROR, "Successfully remove the item",ButtonType.OK).show();
            } catch (Exception e) {
                e.printStackTrace();
